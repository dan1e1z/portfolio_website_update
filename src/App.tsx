  ...
  <Router>
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      ...
      <div className="grain relative min-h-svh w-full overflow-hidden bg-background">
        ...
        <main className="relative z-10 w-full pb-[calc(7rem+env(safe-area-inset-bottom))] pt-[calc(1rem+env(safe-area-inset-top))] md:pb-[calc(8rem+env(safe-area-inset-bottom))] md:pt-[calc(1.5rem+env(safe-area-inset-top))]">
          <PortfolioCanvas />
        </main>
        <Toaster />
      </div>
