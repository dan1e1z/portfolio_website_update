...
export default function Home() {
  ...
  return (
    <div className="w-full bg-background">
      <motion.section ref={heroRef} style={{ scale: heroScale, opacity: heroOpacity, y: heroY }} className="relative content-rail page-gutter flex min-h-[calc(100svh-5rem)] snap-start items-end overflow-hidden pb-20 pt-12 md:pb-28 md:pt-20">
      ...
      <section className="min-h-[calc(100svh-5rem)] w-full snap-start page-gutter py-16 md:py-28"><div className="content-rail">
        <HomeContent />
      </div></section>
    </div>
  );
